...
-- Navigate to the previous diagnostic and open a floating window with details
-- Function to open the floating window with diagnostic details
-- Function to open the floating window with diagnostic details
local function show_diagnostic()
  vim.diagnostic.open_float(nil, { focusable = false })
end

-- Map '[d' to go to the previous diagnostic and show details
vim.keymap.set('n', '[d', function()
  vim.diagnostic.jump { count = -1, float = true }
  show_diagnostic()
end, { desc = 'Go to previous diagnostic and show details' })

-- Map ']d' to go to the next diagnostic and show details
vim.keymap.set('n', ']d', function()
  vim.diagnostic.jump { count = 1, float = true }
  show_diagnostic()
